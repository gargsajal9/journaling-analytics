...
from numpy import zeros, random, sum as np_sum, uint32, float32 as REAL, vstack
...
from gensim_models.word2vec import Word2Vec, Vocab, train_cbow_pair, train_sg_pair
...
def train_sentence_dm(model, sentence, lbls, alpha, work=None, neu1=None, train_words=True, train_lbls=True):
    ...
    for pos, word in enumerate(sentence):
        ...
        neu1e = train_cbow_pair(model, word, word2_indices, l1, alpha, neg_labels, train_w1, train_w2)
