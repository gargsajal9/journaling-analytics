...
input_file_folder = "../datasets/train_test_sets_size_v6_Word/csv/"
#users <- c('M926', 'M300', 'M421', 'M242', 'M118', 'M707', 'M974', 'M600', 'M937', 'M375')
users <- c('M926', 'M300', 'M242', 'M118', 'M707', 'M974', 'M937', 'M375')
