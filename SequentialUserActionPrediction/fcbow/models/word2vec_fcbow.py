...
class Word2Vec(utils.SaveLoad):
    ...
    """
    def __init__(self, sentences=None, size=100, alpha=0.3, window=5, min_count=5,
        sample=0, seed=1, workers=1, min_alpha=0.0001, sg=0, hs=1, negative=0,
        cbow_mean=0, hashfxn=hash, iter=1, context_labeling=False):
        """
        ...
        ''' Newly added variables for F-CBOW '''
        self.context_labeling = context_labeling
        self.new_vocab_syn0 = {}
        self.new_vocab_syn1 = {}
        
        self.new_vocab_vec = {}
        self.new_vocab_code = {}
        self.new_vocab_point = {}
    ...
    ''' Newly added function for F-CBOW '''   
    def add_new_vocab_syn0(self, word, vector):
        self.new_vocab_syn0[word] = vector
    
    ''' Newly added function for F-CBOW '''   
    def add_new_vocab_syn1(self, word, vector):
        self.new_vocab_syn1[word] = vector
